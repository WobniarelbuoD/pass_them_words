...
//html / jsx
  return (
    ...
    <Box sx={{display:"flex",justifyContent:"center",alignItems:{sm:"center",xs:"baseline"}, flexDirection:{md:"row",xs:"column"}, mt:10,}}>
      ...
      <Paper sx={{width:{md:"500px", sm:"400px", xs:"250px", },fontSize:{xl:"2.5rem",lg:"2.5rem",md:"2.5rem",sm:"2rem",xs:"1.5rem"},wordWrap:"break-word"}}>
        <div>{password}</div>
      </Paper>
        <Typography sx={{mt:10, fontSize:{lg:"3rem", md:"2.5rem",sm:"2rem",xs:"1.3rem"}}} variant="h4">Password History</Typography>
      <Paper sx={{width:{md:"500px", sm:"400px", xs:"250px", },minHeight:"50px",fontSize:{md:"2.5rem",sm:"2rem",xs:"1.5rem"}}}>
